...
const port = process.env.PORT || 3000;
  ...
  if (connection === 'close') {
    ...
    let up = `*✨ Hello, FIXO XMD Legend! ✨*

╭─〔 *🤖 FIXO XMD BOT* 〕  
├─▸ *Simplicity. Speed. Power!*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing FIXO XMD!*
...
> _© MADE BY FIXO XD_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/on64af.png` }, caption: up });
  }
});
...
conn.ev.on('messages.upsert', async (msg) => {
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94711767300', '94703945265', '923146190772');
